...
* 可通过在画布中拖动框选 选择多个图层；被隐藏/锁定的图层无法参与框选
* 组图层的选中优先级比组内元素图层高
* <mark style="color:red;">如果想选中组内元素，需要</mark><mark style="color:red;">**双击**</mark><mark style="color:red;">激活该组，再点击选中组内元素；组被激活后，当前组无法再被选中</mark>
