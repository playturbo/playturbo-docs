...
* 适用于如模板"画线救救它"等能够<mark style="color:red;">在区域内自由画线</mark>的玩法。通过「自由画线组件」，实现在指定区域内自由画线，并根据线条触发各种效果（如根据画完的线条生成可碰撞的物体）
...
我们将结合模板[【画线救救它】](http://tinyurl.com/bdcm78r2)进行「自由画线组件」的使用说明
...
<mark style="background-color:yellow;">注：在【画线救救它】模板中，暂不支持调整刚体类型</mark>
