...
请直接查阅 [liang-dian-gong-neng-shi-pin-ai-xiao-chu.md](liang-dian-gong-neng-shi-pin-ai-xiao-chu.md "mention")
...
1.完成所有素材上传后，可在图示位置调整需要裂变的尺寸（支持删除、新增）。系统会根据布局模板的样式自动完成每个尺寸的适配，以适应不同的显示设备或平台需求。此功能可助您轻松修改视频的宽高比例或分辨率，而无需重新编辑整个视频。
