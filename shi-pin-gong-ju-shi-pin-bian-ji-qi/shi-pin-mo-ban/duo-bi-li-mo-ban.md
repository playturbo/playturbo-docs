---
description: '#视频模板 #多比例模板 #快速替换 #视频剪辑'
---
...
## <mark style="color:blue;">一、关于多比例模板</mark>

* 多比例模板将已经设计完成的视频作为模板提供给用户，用户只需替换模板中的内容即可完成视频制作
* 使用多比例模板能够大大提升用户产出视频的效率，同时也能帮助客户完成横竖屏尺寸的视频转换
* 点击模板缩略图即可预览该模板（对于「横版」类型的多比例模板，需要点击预览弹窗中的「横屏」按钮，才能预览到横版最佳效果）
* 多比例模板支持 <mark style="color:red;">**快速替换**</mark>和<mark style="color:red;">**视频剪辑**</mark> 两种编辑模式
...
视频剪辑：通过调整视频截取时间，可以调整想要的视频范围（<mark style="color:red;">**注意：**</mark>若添加的视频时长不足原视频时长，则播放完时将持续展示最后一帧；若添加视频时长超过原视频时长，只播放原视频时长）
...
视频裁剪/图片编辑：可在裁剪页面对视频或图片的大小进行调整。每个比例需要分别进行调整
