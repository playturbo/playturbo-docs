...
轨道区分为以下三部分：轨道操作栏、轨道时间轴、资源轨道

<div align="left">

<img src="../../../.gitbook/assets/0 (45).png" alt="">

</div>

## 1.轨道操作栏

轨道操作栏包含如下操作：撤回、重做、复制、粘贴、分割、删除、设为资产组、折叠/展开音轨、缩放轨道比例

* 撤回：撤回上次进行的修改
* 重做：重做上次撤回的修改
* 复制&粘贴：对轨道区内选中的素材进行复制和粘贴
* 分割：将选中的素材分割成两段素材；分界线为当前的时间游标；点击按钮进行分割操作
...
<figure><img src="../../../.gitbook/assets/image (21) (1) (1) (1) (1) (1) (1) (1) (1) (1).png" alt="" width="524"><figcaption></figcaption></figure>

</div>

<div align="left">

<figure><img src="../../../.gitbook/assets/image (22) (1) (1) (1) (1) (1) (1) (1) (1) (1).png" alt="" width="449"><figcaption></figcaption></figure>
...
* 可对轨道中的素材时长进行延长&缩短
* 操作方法，鼠标移动到素材边缘，点击拖拽边缘，即可延长&缩短素材

### 2）移动素材位置 <a href="#u73df71a4" id="u73df71a4"></a>

* 可移动轨道中的素材位置：包括纵向轨道上的移动、横向时间轴上的移动
* 操作方法，鼠标点击素材并拖拽移动，即可移动素材位置
* 若将素材拖拽出该类型的轨道区域，则生成一个新轨道

### 3）元件多选

* 轨道区内的元件可以通过拖拽框选或使用Ctrl/Shift点选，同时选中多个元件
* 选中的多个元件可以在轨道内拖动，整体改变时间轴位置

### 4）分离音频 <a href="#p5gda" id="p5gda"></a>
...
<img src="../../../.gitbook/assets/8 (12).png" alt="" width="468">
...
（有关时序叉乘的更多内容可查看 [chuang-jian-zi-chan-zu.md](../liang-dian-gong-neng/pi-liang-zu-he-gong-neng-cha-cheng/gong-neng-fen-bu-zhou-jie-shao/chuang-jian-zi-chan-zu.md "mention") [cha-cheng-shi-xu-cha-cheng-jiao-cheng.md](../../../playturbo-an-li-jiao-xue-ji-di/shi-pin-bian-ji-qi-an-li/tong-yong-zhi-zuo-an-li/cha-cheng-shi-xu-cha-cheng-jiao-cheng.md "mention")）
