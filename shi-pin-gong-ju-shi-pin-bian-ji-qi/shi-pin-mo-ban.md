...
* 视频模板将已经设计完成的视频作为模板提供给用户，用户只需替换模板中的内容即可完成视频制作
* 使用视频模板能够大大提升用户产出视频的效率，同时也能帮助客户完成横竖屏尺寸的视频转换
* 点击模板缩略图即可预览该模板（对于「横版」类型的视频模板，需要点击预览弹窗中的「横屏」按钮，才能达到理想效果）
* 视频模板支持 <mark style="color:red;">**快速替换**</mark>和<mark style="color:red;">**视频剪辑**</mark> 两种编辑模式
...
## <mark style="color:blue;">二、快速替换</mark> <a href="#hq5xe" id="hq5xe"></a>

适用场景：不需要精细调整模板，通过替换素材快速产出视频 、 通过模板快速完成视频横转竖、竖转横

### 1.项目创建

入口1：鼠标悬浮于模板缩略图，点击右上方按钮，选择 「快速替换」
...
<mark style="color:red;">**注意： 「快速替换」项目关闭后即被删除**</mark>
...
2）添加需要替换的视频、图片、音频素材。同一个坑位的多个文本，其字体、字号等参数相同。

<mark style="color:red;">**注意：**</mark><mark style="color:red;">添加视频时，原横版视频只能添加横版或方形视频、原竖版视频只能添加竖版或方形视频</mark>
...
3）对视频的时间轴和大小可以进行微调，点击右下方按钮进入裁剪页面
...
通过调整视频截取时间，可以调整想要的视频范围（<mark style="color:red;">**注意：**</mark>若添加的视频时长不足原视频时长，则播放完时将持续展示最后一帧；若添加视频时长超过原视频时长，只播放原视频时长）
...
导出完成后，视频将保存至资产库。可在任务中心查看本次导出进度
...
## <mark style="color:blue;">三、视频剪辑</mark> <a href="#hq5xe" id="hq5xe"></a>

适用场景：「快速替换」不能满足视频制作需求，需要对视频时间结构、布局结构、视频效果进一步调整时使用

### 1.项目创建

入口1：鼠标悬浮于模板缩略图，点击右上方按钮，选择 「视频剪辑」

入口2：点击打开模板弹窗，选择 「视频剪辑」
...
编辑项目名称、选择需要生成的视频比例及语言，则会创建一个 「视频剪辑」项目
...
<figure><img src="../.gitbook/assets/image (1364).png" alt="" width="426"><figcaption></figcaption></figure>

</div>

3）尺寸联动功能：可将每个尺寸设置为「联动」或「不联动」的状态

* 在「联动状态」下，手动调整该「联动」尺寸下的元件尺寸、位置，会影响其他「联动」尺寸下的该元件尺寸、位置
* 在「不联动状态」下，手动调整该「非联动」尺寸下的元件尺寸、位置，不会影响其他尺寸下的该元件尺寸、位置
...
* 可以点击按钮，删除已有的尺寸
* 可以点击该按钮，新增需导出的尺寸，新增的尺寸默认为「不联动」状态
