...
<figure><img src="../../.gitbook/assets/image (2).png" alt="" width="327"><figcaption></figcaption></figure>
...
* 在页面右侧素材选择框中，先选择项目，再选择项目下的创意版本ID

<figure><img src="../../.gitbook/assets/image (4).png" alt=""><figcaption></figcaption></figure>

* 在[「试玩素材分析」](shi-wan-su-cai-fen-xi.md)页面，自定义列选择「素材名称」时，点击表格中的「分析」按钮，跳转到该页面
