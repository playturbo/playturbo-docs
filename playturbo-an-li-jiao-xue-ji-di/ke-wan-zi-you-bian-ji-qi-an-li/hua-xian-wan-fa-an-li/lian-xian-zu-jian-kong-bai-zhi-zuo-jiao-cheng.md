...
1）初始画面参考模板，引导玩家连线进行匹配

2）玩家可从任一元素出发，进行连线匹配

3）匹配成功，播放【正确反馈】；匹配失败，播放【错误反馈】
