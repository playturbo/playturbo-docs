...
| 手机试玩效果最佳                                                                          | 竖屏                                                                                | 横屏                                                                                |
| --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| <img src="../../../.gitbook/assets/image (1299).png" alt="" data-size="original"> | <img src="../../../.gitbook/assets/image (1300).png" alt="" data-size="original"> | <img src="../../../.gitbook/assets/image (1301).png" alt="" data-size="original"> |
| 扫码预览                                                                              | [点击预览](https://tinyurl.com/2dd82ddt)                                              | [点击预览](https://tinyurl.com/2dd82ddt)                                              |
